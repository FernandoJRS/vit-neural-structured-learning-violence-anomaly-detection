...
for i in range(len(X_train)):
    if 'F' in X_train[i]:
        video_frames = read_video(path_videos + 'fight/' + X_train[i], 20, 20, resize=True)
    else:
        video_frames = read_video(path_videos + 'normal/' + X_train[i], 20, 20, resize=True)
...
for i in range(len(X_valid)):
    if 'F' in X_valid[i]:
        video_frames = read_video(path_videos + 'fight/' + X_valid[i], 20, 20, resize=True)
    else:
        video_frames = read_video(path_videos + 'normal/' + X_valid[i], 20, 20, resize=True)
...
for i in range(len(X_test)):
    if 'F' in X_test[i]:
        video_frames = read_video(path_videos + 'fight/' + X_test[i], 20, 20, resize=True)
    else:
        video_frames = read_video(path_videos + 'normal/' + X_test[i], 20, 20, resize=True)
