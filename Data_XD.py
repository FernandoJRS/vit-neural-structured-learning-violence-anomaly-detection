...
#annotations_test = os.listdir(path_base + 'annotations.txt')
...
for i in range(len(videos_train)):
    video_frames = read_video(path_videos_train + videos_train[i], 20, 20, resize=True)
...
for i in range(len(videos_test)):
    video_frames = read_video(path_videos_test + videos_test[i], 20, 20, resize=True)
